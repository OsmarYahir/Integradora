...
fun Platillo.toRecetaSocial(): RecetaSocial {
    return RecetaSocial(
        usuario = "Usuario #$IdUsuario", // Si quieres, ponle nombre real
        imagenUsuario = R.drawable.logo, // Aquí puedes poner un recurso dinámico
        imagenReceta = R.drawable.logo,  // Idem, si tienes URLs usa Coil o Glide
        titulo = Titulo,
